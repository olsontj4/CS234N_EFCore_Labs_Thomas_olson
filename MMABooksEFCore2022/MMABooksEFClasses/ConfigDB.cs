 ...
 *        
 *      Scaffold-DbContext "server=127.0.0.1;uid=root;pwd=PASSWORD;database=MMABooks" Pomelo.EntityFrameworkCore.MySql -OutputDir Models -context MMABooksContext -project MMABooksEFClasses -startupproject MMABooksEFClasses -force
